            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<li>
                     ...
                     <li  >
                        <a  href="sd.php" class="active-menu"><i class="fa fa-table fa-3x"></i>STUDENT DETAILS</a>
                    </li>
               ...
               <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if(isset($_GET['search']))
                        {
                            ...
                            $filter=$_GET['search'];
                            $filterdata="select id,name,email,age,password,category,author,bookname,bid,entrydate,returndate from studet where concat(id,name) like '%$filter%'";
