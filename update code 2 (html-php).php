        ...
        <div id="page-wrapper" >
            <div id="page-inner">
             <div class="container">
                ...
                $id1=$_GET['hr'];
                $que="select * from libr where id=$id1";
                ...
                if($row=mysqli_fetch_array($res))
                {
                 ...
                 <form method="post" action="upd1.php">
                    <label>id</label>
                    <input type="text" name="id"  value="<?php echo $row[0];?>"readonly><br>
                <label>Category</label>
                <select class="form-control" name="cate" value="<?php echo $row[1];?>">
                ...
                <label>Author</label>
                <input type="text" name="auth" class="form-control" value="<?php echo $row[2];?>">

                <label>Books</label>
                <input type="text" name="book" class="form-control" value="<?php echo $row[3];?>"><br>
                


                    <input type="submit" name="n3" class="btn btn-primary" value="Update">
                    <?php
                }
    ?>
</form>
